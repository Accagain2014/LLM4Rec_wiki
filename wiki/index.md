...
| [表示对齐概念页面涵盖](concepts/representation_alignment.md) | --- title: "表示对齐概念页面涵盖" category: "concepts" tags: ["new", "... | "new", "2026-04-08" |

| [从关联章节中检测到的页面](concepts/generative_retrieval.md) | --- title: "从关联章节中检测到的页面" category: "concepts" tags: ["new",... | "new", "2026-04-08" |
...
| [通用搜索单元GSU和精确搜索单元ESU的工业推荐系统范式概念页面解释两阶段检索架构及其在](concepts/gsu_esu_paradigm.md) | --- title: "通用搜索单元GSU和精确搜索单元ESU的工业推荐系统范式概念页面解释两阶段检索架构及其在" ca... | "new", "2026-04-08" |

| [从关联章节中检测到的页面](concepts/semantic_id.md) | --- title: "从关联章节中检测到的页面" category: "concepts" tags: ["new",... | "new", "2026-04-08" |
...
| [从关联章节中检测到的页面](concepts/recif_bench.md) | --- title: "从关联章节中检测到的页面" category: "concepts" tags: ["new",... | "new", "2026-04-08" |
...
| [序列推荐](concepts/.ipynb_checkpoints/sequential_recommendation-checkpoint.md) | --- title: "序列推荐" category: "concepts" tags: [sequential, be... | sequential, behavior, temporal, sequence-modeling |
...
| [多目标偏好对齐方法列表级优化技术](methods/multi_objective_alignment.md) | --- title: "多目标偏好对齐方法列表级优化技术" category: "methods" tags: ["ne... | "new", "2026-04-08" |
...
| [HiGR](models/HiGR.md) | --- title: "HiGR" category: "models" tags: ["new", "2026-04-... | "new", "2026-04-08" |

| [从关联章节中检测到的页面](models/OneRec-Think.md) | --- title: "从关联章节中检测到的页面" category: "models" tags: ["new", "... | "new", "2026-04-08" |

| [PLUM](models/PLUM.md) | --- title: "PLUM" category: "models" tags: ["new", "2026-04-... | "new", "2026-04-08" |

| [Qwen 系列](models/qwen_series.md) | --- title: "Qwen 系列" category: "models" tags: [Qwen, Bailian... | Qwen, Bailian, Alibaba, model-family, cloud |

| [从关联章节中检测到的页面](models/GRID.md) | --- title: "从关联章节中检测到的页面" category: "models" tags: ["new", "... | "new", "2026-04-08" |

| [Tiger](models/DSI.md) | --- title: "Tiger" category: "models" tags: ["new", "2026-04... | "new", "2026-04-08" |

| [从关联章节中检测到的页面](models/OneRec-V2.md) | --- title: "从关联章节中检测到的页面" category: "models" tags: ["new", "... | "new", "2026-04-09" |
...
| [InstructRec](models/.ipynb_checkpoints/InstructRec-checkpoint.md) | --- title: "InstructRec" category: "models" tags: [InstructR... | InstructRec, instruction-tuning, LLM, conversational |

| [LLMRank](models/.ipynb_checkpoints/LLMRank-checkpoint.md) | --- title: "LLMRank" category: "models" tags: [LLMRank, list... | LLMRank, listwise, ranking, pointwise, pairwise |

| [创建DSIDifferentiable](models/.ipynb_checkpoints/DSI-checkpoint.md) | --- title: "创建DSIDifferentiable" category: "models" tags: ["... | "new", "2026-04-08" |

| [TALLRec](models/.ipynb_checkpoints/TALLRec-checkpoint.md) | --- title: "TALLRec" category: "models" tags: [TALLRec, effi... | TALLRec, efficient-tuning, LoRA, LLM, adaptation |

| [P5 — 个性化提示学习](models/.ipynb_checkpoints/P5-checkpoint.md) | --- title: "P5 — 个性化提示学习" category: "models" tags: [P5, prom... | P5, prompt, personalization, unified, multi-task |

| [QARM](models/.ipynb_checkpoints/QARM-checkpoint.md) | --- title: "QARM" category: "models" tags: ["new", "2026-04-... | "new", "2026-04-08" |

| [HiGR](models/.ipynb_checkpoints/HiGR-checkpoint.md) | --- title: "HiGR" category: "models" tags: ["new", "2026-04-... | "new", "2026-04-08" |

| [从关联章节中检测到的页面](models/.ipynb_checkpoints/OneRec-checkpoint.md) | --- title: "从关联章节中检测到的页面" category: "models" tags: ["new", "... | "new", "2026-04-08" |

| [Qwen 系列](models/.ipynb_checkpoints/qwen_series-checkpoint.md) | --- title: "Qwen 系列" category: "models" tags: [Qwen, Bailian... | Qwen, Bailian, Alibaba, model-family, cloud |
...
| [腾讯公司推荐系统团队和工业实践包括](entities/.ipynb_checkpoints/tencent-checkpoint.md) | --- title: "腾讯公司推荐系统团队和工业实践包括" category: "entities" tags: ["... | "new", "2026-04-08" |

| [阿里云百炼平台](entities/.ipynb_checkpoints/bailian_platform-checkpoint.md) | --- title: "阿里云百炼平台" category: "entities" tags: [Bailian, Al... | Bailian, Alibaba, cloud, platform, API, Qwen |

| [GoogleYouTube](entities/.ipynb_checkpoints/google_youtube-checkpoint.md) | --- title: "GoogleYouTube" category: "entities" tags: ["new"... | "new", "2026-04-08" |

| [MovieLens 数据集](entities/.ipynb_checkpoints/movielens-checkpoint.md) | --- title: "MovieLens 数据集" category: "entities" tags: [datas... | dataset, movielens, movies, benchmark, ratings |

| [Amazon 评论数据集](entities/.ipynb_checkpoints/amazon_reviews-checkpoint.md) | --- title: "Amazon 评论数据集" category: "entities" tags: [datase... | dataset, amazon, e-commerce, reviews, benchmark |

| [Kuaishou](entities/.ipynb_checkpoints/kuaishou-checkpoint.md) | --- title: "Kuaishou" category: "/" tags: ["new", "2026-04-0... | "new", "2026-04-08" |

| [周国瑞研究员个人页面涵盖其在推荐系统领域的贡献](entities/.ipynb_checkpoints/guorui_zhou-checkpoint.md) | --- title: "周国瑞研究员个人页面涵盖其在推荐系统领域的贡献" category: "entities" ta... | "new", "2026-04-08" |
...
| [源论文摘要页面包含论文元数据核心贡献方法概述关键发现和与现有研究的关联](sources/paper_QARM_V2_Quantitative_Alignment_Multi-Modal_Recommendation.md) | --- title: "源论文摘要页面包含论文元数据核心贡献方法概述关键发现和与现有研究的关联" category: "... | "new", "2026-04-08" |
...
| [源论文摘要页面本次任务重点](sources/paper_ad0dff_QARM_Quantitative_Alignment_Multi-Modal_Recommendation_at_K.md) | --- title: "源论文摘要页面本次任务重点" category: "sources" tags: ["new",... | "new", "2026-04-08" |
...
| [Paper 8Edbf8 Higr Efficient Generative Slate Recommendation Via Hierarch](sources/.ipynb_checkpoints/paper_8edbf8_HiGR_Efficient_Generative_Slate_Recommendation_via_Hierarch-checkpoint.md) | --- title: "Paper 8Edbf8 Higr Efficient Generative Slate Rec... | "source", "2026-04-08" |

| [Paper 81Ec38 Plum Adapting Pre-Trained Language Models For Industrial-Sc](sources/.ipynb_checkpoints/paper_81ec38_PLUM_Adapting_Pre-trained_Language_Models_for_Industrial-sc-checkpoint.md) | --- title: "Paper 81Ec38 Plum Adapting Pre-Trained Language... | "source", "2026-04-08" |

| [Paper 260110 Actions Speak Louder Than Words Trillion-Parameter Sequenti](sources/.ipynb_checkpoints/paper_260110_Actions_Speak_Louder_than_Words_Trillion-Parameter_Sequenti-checkpoint.md) | --- title: "Paper 260110 Actions Speak Louder Than Words Tri... | "source", "2026-04-08" |

| [源论文摘要页面本次任务重点](sources/.ipynb_checkpoints/paper_ad0dff_QARM_Quantitative_Alignment_Multi-Modal_Recommendation_at_K-checkpoint.md) | --- title: "源论文摘要页面本次任务重点" category: "sources" tags: ["new",... | "new", "2026-04-08" |
