...
- 参见 [生成式推荐数据-模型-任务框架](../concepts/data_model_task_framework.md) 了解三分法架构与 Agent 仿真数据构建路径

## 开放问题

1. LLM 与传统 RecSys 组件之间的最佳平衡是什么？
2. 除了标准排序指标之外，如何可靠地评估 LLM4Rec 系统的生成质量、逻辑一致性与多轮交互能力？
...
10. 基于 Agent 的仿真数据生成能否完全替代真实用户反馈？如何验证仿真轨迹与真实分布的一致性？
11. 如何设计轻量化的缓存与投机解码策略，将生成式推荐的推理延迟压缩至工业级毫秒级要求？
...
- **A Survey on Generative Recommendation: Data, Model, and Tasks** (Hou et al., arXiv:2510.27157, 2025)

## 更新于 2026-04-12

**来源**: [2510_paper_25102715_A_Survey_on_Generative_Recommendation_Data,_Model,_and_Task.md](../sources/2510_paper_25102715_A_Survey_on_Generative_Recommendation_Data,_Model,_and_Task.md)
：补充“数据-模型-任务”三分框架作为 LLM4Rec 演进的核心分类视角，更新生成式推荐范式的优势与挑战宏观描述，整合 Agent 仿真数据、跨模态对齐、对比生成损失及实证性能指标（NDCG/Recall 提升 15%~30%，CSAT 提升 20%~40%，延迟 2~5 倍，幻觉率 5%~12%），替换原有碎片化分类体系。

---

## 更新完成：2510_paper_25102715_A_Survey_on_Generative_Recommendation_Data,_Model,_and_Task.md
**更新时间**: 2026-04-12 16:49
